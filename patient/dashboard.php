...
try {
    $db = getDBConnection();
    $stmt = $db->prepare("SELECT COUNT(*) AS notification_count FROM Notification WHERE UserID = ?");
    $stmt->execute([$_SESSION['user_id']]);
            ...
            <div class="col-lg-5 col-md-7">
                <div class="nav-card">
                    <div class="nav-header">
                        <h4 class="mb-0"><i class="fas fa-user-injured me-2"></i>Patient Home</h4>
                    </div>
                    <div class="list-group list-group-flush">
                        ...
                        <a href="make_appointment.php" class="list-group-item list-group-item-action nav-item nav-link">
                        ...
                        <a href="manage_appointment.php" class="list-group-item list-group-item-action nav-item nav-link">
                            <i class="fas fa-history"></i>View Appointments History
                        </a>
                        <a href="chat_list.php" class="list-group-item list-group-item-action nav-item nav-link">
                            <i class="fas fa-comment-medical"></i>Chat with a Doctor
                        </a>
                        <a href="notification.php" class="list-group-item list-group-item-action nav-item nav-link">
                            <i class="fas fa-bell"></i>Notifications
                            <?php if ($notification_count > 0): ?>
                                <span class="badge bg-primary rounded-pill ms-auto"><?php echo htmlspecialchars($notification_count); ?></span>
                            <?php endif; ?>
                        </a>
